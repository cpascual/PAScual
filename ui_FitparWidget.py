...
#
# Created: Thu May 29 01:12:15 2008
...
class Ui_FitparWidget(object):
    def setupUi(self, FitparWidget):
        ...
        FitparWidget.resize(QtCore.QSize(QtCore.QRect(0,0,657,33).size()).expandedTo(FitparWidget.minimumSizeHint()))
        ...
        self.BTApply.setIcon(QtGui.QIcon(":/Icons/Icons/mine/CRbutton_ok.png"))
        ...
        self.BTAutoFill.setIcon(QtGui.QIcon(":/Icons/Icons/mine/CRcalc.png"))
