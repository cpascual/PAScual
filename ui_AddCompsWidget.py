...
#
# Created: Mon Jun 16 18:04:40 2008
...
class Ui_AddCompsWidget(object):
    def setupUi(self, AddCompsWidget):
        ...
        spacerItem = QtGui.QSpacerItem(72,163,QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Expanding)
        ...
        QtCore.QObject.connect(self.resetBT,QtCore.SIGNAL("clicked()"),self.selectionsTE.clear)
        QtCore.QMetaObject.connectSlotsByName(AddCompsWidget)

    def retranslateUi(self, AddCompsWidget):
        AddCompsWidget.setWindowTitle(QtGui.QApplication.translate("AddCompsWidget", "Form", None, QtGui.QApplication.UnicodeUTF8))
        self.addpPsBT.setText(QtGui.QApplication.translate("AddCompsWidget", "Add pPs (125 ps)", None, QtGui.QApplication.UnicodeUTF8))
        self.selectionsTE.setToolTip(QtGui.QApplication.translate("AddCompsWidget", "Add components using the buttons on the left or enter them manually.\n"
"Format: lifetime [, min, max]", None, QtGui.QApplication.UnicodeUTF8))
        self.addDirectBT.setText(QtGui.QApplication.translate("AddCompsWidget", "Add Direct (400 ps)", None, QtGui.QApplication.UnicodeUTF8))
        self.addoPsBT.setText(QtGui.QApplication.translate("AddCompsWidget", "Add oPs (2000 ps)", None, QtGui.QApplication.UnicodeUTF8))
        self.addCustomBT.setText(QtGui.QApplication.translate("AddCompsWidget", "Add custom", None, QtGui.QApplication.UnicodeUTF8))
        self.resetBT.setText(QtGui.QApplication.translate("AddCompsWidget", "Reset", None, QtGui.QApplication.UnicodeUTF8))
